...
#نصب
```
git clone https://github.com/ptwebco/hobto.git && cd hobto && chmod 777 install.sh && chmod +x hobto.sh && ./install.sh
```
...
#Opened By: [@hobto](http://telegram.me/ptwebco)

#Developer: ptwebco.ir
